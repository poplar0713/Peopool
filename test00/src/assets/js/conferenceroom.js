...
const conferenceroom = { ws, name, participants, register, onParticipantLeft, sendMessage, receiveVideo, leaveRoom, onExistingParticipants, callResponse, receiveVideoResponse, onNewParticipant}
