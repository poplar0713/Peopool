...
<!-- Form -->
  <div>
    <div class="loginbutton">
        ...
        <el-button type="warning" plain @click="$store.state.LoginDialog = true" style="width:30%">시작하기</el-button>
    </div>
    <br>
    <el-dialog title="Login" v-model="$store.state.LoginDialog">
        ...
        <el-tab-pane label="개인회원" name="first">
          ...
          <!-- 회원가입했니? -->
          <div>
            <el-button type="text" @click="$store.state.SignupDialogIndiv = true" style="color:black">아직 회원이 아니신가요?</el-button>
            <el-dialog title="Signup" v-model="$store.state.SignupDialogIndiv" width="30%" :before-close="handleClose">
              <!-- 개인회원가입 -->
              <SignupIndiv/>
            </el-dialog>
          </div>
        ...
        <el-tab-pane label="기업회원" name="second">
            <LoginCompany/>
          <div>
            <el-button type="text" @click="$store.state.SignupDialogCompany = true" style="color:black">아직 (기업)회원이 아니신가요?</el-button>
            <el-dialog
            title="Signup"
