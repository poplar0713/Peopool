<template>
    ...
    <el-form-item label="Password Confirmation" prop="SignupCompanyPWConfirm">
        <el-input type="password" v-model="ruleForm.SignupCompanyPWConfirm"></el-input>
    </el-form-item>
    <!-- 공개여부 -->
    ...
    <el-form-item>
        ...
        <el-button type="warning" @click="submitForm('ruleForm')">Create</el-button>
    </el-form-item>
    </el-form>
</template>
      ...
      return {
        ...
        rules: {
          ...
          SignupCompanyPWConfirm: [
            ...
            { min: 10, max: 15, message: 'Length should be 10 to 15', trigger: 'blur' },
            { required: "this.SignupCompanyPW==this.SignupCompanyPWConfirm", message: 'Please Check your PW or PW confirmation', trigger: 'blur'},
          ],
        }
      };
    },
