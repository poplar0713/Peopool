...
stages {
    ...
    stage('Docker run') {
        ...
        steps{
            ...
            sh 'docker run -d --name peopoolbe -p 8443:8443 -v /home/ubuntu/upload/:/var/empty/ -e JAVA_TOOL_OPTIONS="-Dkms.url=ws://52.79.162.52:8888/kurento" --network peopoolnet peopoolbe:latest '
